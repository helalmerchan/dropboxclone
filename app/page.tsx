    ...
    <main className="">
      <div className="flex flex-col lg:flex-row items-center bg-[#1E1919]">
        <div className="p-10 flex h-full flex-col bg-[#2b2929] dark:bg-slate-800 text-white space-y-5">
          <h2 className="text-3xl font-bold">Welcome to Dropbox <br /><br />
      ...
      <p className="text-center font-light p-2">This website is made for practice and educational purposes only. We do not own or affiliate with Dropbox and/or any of its subsidiaries in any form. Copyright Disclaimer under section 107 of the Copyright Act 1976, allowance is made for “fair use” of this video for education purposes.</p>
    </main>
